...
### KalimantanBio ([https://kalimantanbio.com](https://kalimantanbio.com))
...
[Open-World Lifelong Plant Recognition](https://kalimantanbio.com/identifier/) explores AI systems capable of recognizing known plant species, detecting previously unknown species, and progressively learning new species over time.
...
<!-- **Problem → Data → Experiment → Software → Analysis → Research Output** -->
...
The **EAIR Bulletin** communicates research activities, project developments, data insights, field observations, and emerging technologies related to environmental and agroecological informatics.

Unlike traditional academic publications, the bulletin is intended to communicate research in a concise and accessible format.

[Read the EAIR Bulletin →](/bulletin/) -->
