...
The Aerial Analytics Platform is designed to process and analyze RGB aerial imagery captured using standard drones. Each module focuses on a specific analytical problem and is designed to be manageable by a group of four bachelor students.
...
Develop a system for organizing aerial imagery and managing aerial monitoring projects.
...
### Module 2: Aerial Image Map Explorer

Develop an interactive map for exploring aerial images and their associated geographic locations.

Possible Features:

- Geo-Referenced Image Explorer: Display aerial images according to their GPS locations.
- Image Location Marker: Show the acquisition location of individual aerial images.
- Area of Interest Selection: Allow users to select specific areas for exploration or analysis.
- Layer Management: Display and control imagery, boundaries, and analytical layers.
- Spatial Measurement: Measure distance, area, and perimeter.
- Spatial Annotation: Allow users to mark and annotate locations or areas of interest.


### Module 3: RGB Vegetation Detection

Develop an image-processing system for identifying vegetation from standard RGB aerial imagery.

Possible Features:

- Vegetation Detection: Separate vegetation from non-vegetation areas using RGB information.
- RGB Vegetation Indices: Apply RGB-based indices such as ExG, ExR, or VARI.
- Vegetation Mask Generation: Generate binary or classified vegetation masks.
- Green Pixel Analysis: Analyze vegetation based on RGB color characteristics.
- Detection Threshold Adjustment: Allow users to adjust vegetation detection parameters.
- Detection Visualization: Overlay detected vegetation on the original aerial image.


### Module 4: Vegetation Coverage Analytics

Develop an analytical system for quantifying vegetation coverage using vegetation detection results.

Possible Features:

- Vegetation Coverage Estimation: Calculate the percentage of an area covered by vegetation.
- Vegetation Area Calculation: Estimate the total vegetation-covered area.
...
- Vegetation Coverage Visualization: Display coverage statistics and spatial results.


### Module 5: RGB Vegetation Condition Analysis

Develop a system for analyzing visible vegetation conditions using color information from RGB aerial imagery.
...
- Vegetation Condition Classification: Categorize vegetation into predefined visual condition classes.
- Yellowing Detection: Identify vegetation areas showing visible yellowing.
- Browning Detection: Identify vegetation areas showing visible browning or dry appearance.
...
### Module 6: Tree Detection & Counting

Develop a computer vision system for detecting and counting visible trees from aerial RGB imagery.

Possible Features:

- Tree Detection: Detect individual trees or tree crowns from aerial images.
- Tree Counting: Automatically calculate the number of detected trees.
- Confidence Filtering: Filter tree detections according to prediction confidence.
- Tree Location Mapping: Display detected trees according to their spatial locations.
- Area-Based Tree Counting: Calculate the number of trees within selected areas or plots.
- Tree Density Analysis: Calculate tree density per unit area.
- Detection Review: Allow users to review and correct detection results.


### Module 7: Object Detection & Counting

Develop a flexible computer vision system for detecting and counting selected objects from aerial RGB imagery.

Possible Features:

- Object Detection: Detect selected objects such as animals, vehicles, buildings, or other visible targets.
- Object Classification: Distinguish between supported object categories.
- Object Counting: Calculate the number of detected objects.
- Confidence-Based Filtering: Filter detections according to prediction confidence.
- Area-Based Counting: Count detected objects within selected areas.
- Object Distribution Analysis: Analyze the spatial distribution of detected objects.
- Detection Visualization: Display bounding boxes and detection results on aerial images.


### Module 8: RGB Land-Cover Classification

Develop a system for classifying visible land-cover types from standard RGB aerial imagery.

Possible Features:

- Land-Cover Classification: Classify visible surfaces into vegetation, bare soil, water, built areas, or other relevant classes.
- Custom Class Definition: Allow projects to define appropriate land-cover categories.
...
- Land-Cover Map: Visualize classified land-cover results.
- Plot-Based Land-Cover Analysis: Compare land-cover composition among selected plots.


### Module 9: Area & Plot Analytics

Develop a spatial analytical system for defining study plots and summarizing aerial analysis results within them.

Possible Features:

- Plot Definition: Create or import plot boundaries.
- Area Calculation: Calculate the size of selected plots or areas.
...
- Multi-Plot Comparison: Compare analytical indicators among different plots.
...
- Before-and-After Comparison: Compare aerial imagery from two observation periods.
- Vegetation Coverage Change: Calculate changes in vegetation coverage between observations.
- Land-Cover Change: Identify changes among visible land-cover classes.
- Object Count Change: Compare detected object counts between observation periods.
- Change Magnitude Analysis: Calculate the amount of observed change.
- Change Area Detection: Identify locations where significant changes have occurred.
- Change Visualization: Display before-and-after results and detected changes.


### Module 11: Aerial Analytics Dashboard & Reporting

Develop an integrated interface for summarizing and communicating results produced by the Aerial Analytics Platform.

Possible Features:

- Project Analytics Dashboard: Display important analytical indicators for each project.
- Analysis Result Summary: Summarize results produced by different analytical modules.
- Plot Comparison Dashboard: Compare analytical indicators among selected plots.
- Temporal Summary: Present changes in analytical indicators across observation periods.
- Interactive Result Explorer: Connect analytical summaries with corresponding images and locations.
- Charts and Statistics: Present analytical results using appropriate charts and summary statistics.
- Report Generation: Generate structured reports containing analytical results, figures, maps, and statistics.
- Data Export: Export analytical results for further GIS, statistical, or research analysis.