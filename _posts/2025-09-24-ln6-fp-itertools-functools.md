...
3. Please create HOFs named "ON" in which taking a function to apply into two different values and compare the results using binary function that return true or false. For example  **(points: 15)**:
```
